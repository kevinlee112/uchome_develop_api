...
$acs = array(
	array('index','config','channel','privacy', 'ip', 'spam', 'hotuser', 'defaultuser', 'usergroup',
		'credit','creditlist','taskmanage','taskcount','moneylist','messagelog','messagerule','moneylog',
		'moneylogb','moneytype','creditstore','subject','banner', 'magic', 'magiclog', 'profield', 'ad',
		'userapp','dashenbang','autoaward','goodsstore', 'goodscategory', 'goodsplatform', 'goodsorder'),
	array('tag', 'mtag', 'event', 'report', 'space','productanalyze','notemanage','noteanalyze','exportexcel','delwroreg','checkauto','moneyrange'),
	array('cache', 'network', 'profilefield', 'eventclass', 'click', 'task', 'censor', 'stat', 'block', 'cron', 'app', 'log', 'batch'),
