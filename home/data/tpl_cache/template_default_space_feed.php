<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_feed|template/default/header|template/default/space_status|template/default/space_menu|template/default/space_feed_li|template/default/space_feed_li|template/default/space_feed_li|template/default/footer', '1495096636', 'template/default/space_feed');?><?php if(empty($_TPL['getmore'])) { ?>	
...
<span class="gray">datelinee('m-d H:i',<?=$value['dateline']?>,1)}--></span>
<?php } ?>
...
<p class="gray">datelinee('n月j日',<?=$value['dateline']?>,1)}--></p>
</li>
<?php } } ?>
</ul>
</div>
...
<p{if <?=$ols[$value['vuid']]?>} class="online_icon_p" title="在线"<?php } ?>><a href="space.php?uid=<?=$value['vuid']?>" title="<?=$_SN[$value['vuid']]?>"><?=$_SN[$value['vuid']]?></a></p>
<p class="gray">datelinee('n月j日',<?=$value['dateline']?>,1)}--></p>
<?php } ?>
</li>
<?php } } ?>
