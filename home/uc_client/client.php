...
function uc_user_appregister($username, $password, $email = '', $questionid = '', $answer = '') {
        return call_user_func(UC_API_FUNC, 'user', 'appregister', array('username'=>$username, 'password'=>$password, 'email'=>$email, 'questionid'=>$questionid, 'answer'=>$answer));
}
