...
//开通空间
function space_open($uid, $username, $gid=0, $email='', $qq=0, $msn=0, $deviceid='') {
	...
	inserttable('spacefield', array('uid'=>$uid, 'email'=>$email, 'qq'=>$qq, 'msn'=>$msn, 'deviceid'=>$deviceid), 0, true);
