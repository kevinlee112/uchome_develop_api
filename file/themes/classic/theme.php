...
function page_header($title,$show = true) {
  ...
  echo "<html>\n<head>\n"
      ."<title>$sitetitle :: $title »   Powerd by ququyouxi</title>\n"
...
function page_footer() {
  ...
  echo "</table></table><tr><td align=right><font class=copyright>Powerd by <a href=http://www.ququyouxi.com/>ququyouxi</a><br>&copy; 2013-".date("Y")."</font></table>\n"
      ."</body>\n"
      ."</html>\n";
  die();
}
